...
SECRET_KEY = 'django-insecure-axgmn25$p%$&80kymqi-7_kkq#^qo8b5&0)0%rm-fwj-ilcwqw'
...
INSTALLED_APPS = [
    ...
    'documentos',  # Added the documentos app
]
...
STORAGES = {
    ...
    "photos": {
        "BACKEND": "django.core.files.storage.FileSystemStorage",
        "OPTIONS": {
            "location": BASE_DIR / "media" / "photos",
    ...
    "documents": {
        "BACKEND": "django.core.files.storage.FileSystemStorage",
        "OPTIONS": {
            "location": BASE_DIR / "media" / "documents",
